...
class TestGaucCalculator:
    ...
    @pytest.mark.auc
    def test_auc_calculate__watch_coverage_30s__4209389434_2808_1769884974477_49306(
        self,
        test_data_dir,
    ...
    @pytest.mark.auc
    def test_auc_calculate__watch_coverage_30s__918960451_4009_1769879722682_60050(
        self,
        test_data_dir,
        target_config_watch_coverage_30s,
    ):
        target_event = "watch_coverage_30s"
        path_to_pool_cache_file = test_data_dir.joinpath(
            f"./AUC=0_0/pool_cache_2026_01_31__918960451_4009_1769879722682_60050.jsonl"
        )
        rid = _get_rid_from_pool_cache_file_name(path_to_pool_cache_file)
